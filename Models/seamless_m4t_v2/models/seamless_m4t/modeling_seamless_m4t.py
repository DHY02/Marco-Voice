...
class SeamlessM4TEncoder(SeamlessM4TPreTrainedModel):
    def __init__(
        ...
        self.embed_tokens = SeamlessM4TScaledWordEmbedding(
            config.t2u_vocab_size if is_t2u_encoder else config.vocab_size,
            embed_dim,
            self.padding_idx,
...
class SeamlessM4TTextToUnitModel(SeamlessM4TPreTrainedModel):
    def __init__(
        ...
        self.encoder = SeamlessM4TEncoder(config, is_t2u_encoder=False)
...
class SeamlessM4TCodeHifiGan(PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # print("config.vocoder_num_spkrs:", config.vocoder_num_spkrs,# 10 "config.spkr_embed_dim:", config.spkr_embed_dim, 256)
    ...
    def forward(
        ...
        print("lang:", lang.shape, hidden_states.shape, spkr.shape)
...
class SeamlessM4TForTextToSpeech(SeamlessM4TPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config: SeamlessM4TConfig):
        ...
        self.t2u_model = SeamlessM4TTextToUnitForConditionalGenerationWithEmotionEmbedding(config)
        self.vocoder = SeamlessM4TCodeHifiGanWithEmotion(config)
...
__all__ = [
    ...
    "SeamlessM4TCodeHifiGanWithEmotion",
    "SeamlessM4TCodeHifiGanWithEmoSphere",
    "SeamlessM4TTextToUnitForConditionalGenerationWithEmotionEmbedding",
    "SeamlessM4TTextToUnitForConditionalGenerationWithEmoSphere",
]
