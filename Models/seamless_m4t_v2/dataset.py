...
from seamless_m4t_v2.datasets.huggingface import (
    Speech2SpeechFleursDatasetBuilder,
    SpeechTokenizer,
)
from seamless_m4t_v2.models.unit_extractor import UnitExtractor
...
# python dataset.py --name google/fleurs --source_lang eng --target_lang kor --split train --save_dir data/fleurs/